          ...
          <div className="">
            <div className="admin-dashboard">
              <div className="title-header">
                <h5 className="card-header-01 text-center">Pickup Creation</h5>
                  ...
                  <div className="row">
                    <div className="mb-4 w-50">
                      ...
                      <div className="checkbox-col d-flex">
                        <input type="checkbox" id="vehicle1" name="vehicle1" value="shipment"  onChange={(e)=> setShipment(e.target.value)}/>
